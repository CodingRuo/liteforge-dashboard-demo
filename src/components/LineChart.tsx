...
function toPoints(values: number[], H: number, yMax: number): string {
        ...
        <div style="display:flex;flex-wrap:wrap;gap:16px;margin-top:4px">
          {props.labels.map((label, i) => (
            <div style="display:flex;align-items:center;gap:6px">
              <span style={`display:inline-block;width:12px;height:2px;border-radius:1px;background:${props.colors[i] ?? '#00C49A'}`} />
